local function button(text, func, funcArgs, x, y, width, height, colorIdle, colorTextIdle, modeIdle, colorHighlighted, colorTextHighlighted, modeHighlighted, colorActive, colorTextActive, modeActive)
    return {
        text = text or "Empty",
        func = func or function() print("no funcion in the button") end,
        funcArgs = funcArgs,
